...
export default function FAQs() {
  return (
    <div id='faqs'>
      ...
      <p>To place an order, simply browse our website and add the desired books to your cart. Once you have selected all the books you wish to purchase, proceed to the checkout page and follow the prompts to complete your order.</p>
      <h4>2. What payment methods do you accept?</h4>

      <p>We accept various payment methods, including credit cards, debit cards, and PayPal. Rest assured that all transactions are secure and your payment information is protected.</p>
    ...
    {/* <div>
    Here are some frequently asked questions that you might find in a bookstore FAQs page:
